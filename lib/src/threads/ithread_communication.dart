...
import 'package:maxi_library/src/threads/ithread_communication_method.dart';
...
import 'package:maxi_library/src/threads/ithread_stream_manager.dart';

mixin IThreadCommunication {
  IThreadCommunicationMethod get port;
  IThreadProcess get manager;
