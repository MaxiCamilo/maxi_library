    ...
    if (value == null) {
      if (hasDefaultValue) {
        ...
        throw NegativeResult(
          ...
          message: Oration(message: 'The parameter named %1 needs a value', textParts: [name]),
        );
      }
    } else if (value is T) {
      return value;
      ...
      throw NegativeResult(
        ...
        message: Oration(
          message: 'The parameter named %1 is expected to be of type %2, but the value provided (%3) is not compatible',
